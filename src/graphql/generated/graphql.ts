...
export type WebsiteFragment = { __typename?: 'Website', cms?: WebsiteCms | null, cmsApiToken?: string | null, cmsApiUrl?: string | null, cmsConfig?: any | null, companyId: string, createdAt: any, description?: string | null, hasCmsApiToken: boolean, id: string, title: string, updatedAt: any } & { ' $fragmentName'?: 'WebsiteFragment' };
...
export type ListWebsiteSeoPageQuery = { __typename?: 'Query', listWebsiteSeoPage: Array<{ __typename?: 'WebsiteSeoPage', apiId: string, contentType: ContentDataType, document: string, documentId: string, documentTitle: string, id: number, title: string, url: string }> };
